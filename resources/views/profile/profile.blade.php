...
<div id="mainContent" class="flex lg:h-full max-w-full">
    <div class="flex flex-col h-full w-full">
        ...
        <div class="flex justify-between items-center rounded-lg mx-4 mt-1 py-1">
            ...
            <button class="flex items-center space-x-2 px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors">
        ...
        <div class="flex flex-col rounded-lg border bg-gray-50 mx-4 my-1 h-3/5">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center w-full h-full lg:space-x-6 px-4 ">
                ...
                <div class="w-1/5  flex flex-col items-center justify-center rounded-md px-4 lg:py-2 py-8 ">
                    <div class="w-32 h-32 rounded-full border-2 border-dashed border-gray-400 flex justify-center items-center">
                        <div class="w-28 h-28 rounded-full bg-gray-200 border-1 border-gray-300 flex items-center justify-center">
                ...
                <div class="w-full lg:w-2/5 space-y-4 ">
                    <div>
                        ...
                        <p class="w-full px-3 py-2 text-sm border bg-white border-gray-300 rounded-md text-gray-500">First Name</p>
                    </div>

                    <div>
                        <label class="block text-sm font-normal text-gray-700 mb-1">Email address</label>
                        <p class="w-full px-3 py-2 text-sm border bg-white border-gray-300 rounded-md text-gray-500">Email address</p>
                    </div>

                    <div>
                        <label class="block text-sm font-normal text-gray-700 mb-1">Role</label>
                        <p class="w-full px-3 py-2 text-sm border bg-white border-gray-300 rounded-md text-gray-500">Role</p>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-2/5 space-y-4 py-4 lg:py-0 ">
                    <div>
                        ...
                        <p class="w-full px-3 py-2 text-sm border bg-white border-gray-300 rounded-md text-gray-500">Last Name</p>
                    </div>

                    <div>
                        <label class="block text-sm font-normal text-gray-700 mb-1">NIC number</label>
                        <p class="w-full px-3 py-2 text-sm border bg-white border-gray-300 rounded-md text-gray-500">NIC number</p>
                    </div>

                    <div>
                        <label class="block text-sm font-normal text-gray-700 mb-1">Phone number</label>
                        <p class="w-full px-3 py-2 text-sm border bg-white border-gray-300 rounded-md text-gray-500">Phone number</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col rounded-lg border bg-gray-50 mx-4 my-2 mb-4 h-2/5 ">
            ...
            <div class="flex flex-col space-y-4 px-4 pt-00 pb-4 pt-4 h-full justify-center">
                <div class="w-full lg:w-1/3">
                    ...
                    <input type="password" placeholder="Enter Current Password" class="w-full lg:w-80 pr-4 max-w-sm px-3 lg:py-1.5 py-2  border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm text-gray-500">
                </div>
                ...
                <div class="flex lg:space-x-4 flex-col lg:flex-row">
                    <div class="w-full lg:w-2/3 flex flex-col lg:flex-row lg:space-x-4 space-y-4 lg:space-y-0">
                        <div class="w-full lg:w-1/2">
                            ...
                            <input type="password" placeholder="Enter New Password" class="w-full lg:w-80 px-3 max-w-sm lg:py-1.5 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm text-gray-500">
                        </div>
                        <div class="w-full lg:w-1/2">
                    ...
                    <!--Button-->
                    <div class="flex lg:justify-end space-x-3  items-end lg:text-xs text-sm lg:w-1/3 w-full justify-center pt-8 lg:pt-0" >
                        <button class="px-8 py-2 text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors w-1/2 lg:w-36">
                            Save
                        </button>
                        <button class="px-8 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors w-1/2 lg:w-36">
                            Edit
                        </button>
                    </div>
