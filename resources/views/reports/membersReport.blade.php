    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300 lg:relative lg:py-4">
        ...
        <div class="flex lg:w-1/2 lg:h-20 w-full px-2 lg:px-0 py-4 lg:py-0">
            ...
            <div id="topCards" class="grid grid-cols-1 lg:flex gap-2 lg:gap-08 w-full lg:p-0 lg:pb-4 ">
                <!--Active Card-->
                <div id="activeMembers" class="px-4 py-2 lg:py-8 rounded-lg shadow-sm flex justify-between items-center w-full border border-gray-300 bg-green-300">
                ...
                <div id="inactiveMembers" class="px-4 py-2 lg:py-8 rounded-lg shadow-sm flex justify-between items-center w-full border border-gray-300 bg-red-300 ">
                    <div class="flex flex-col w-1/2">
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-h-5/6">
            ...
            <div id="activeSection" class="active-content">
                ...
                <div id="activeLoanIssueGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2 pt-4">
                    <div class="rounded-md shadow flex flex-col justify-between w-full bg-blue-200 hover:bg-blue-300" data-name="Dunura Rubasinghe" data-NIC="200128574963">
                ...
                <div class="flex justify-start h-full pt-2">
                    <div id="activeLoanIssueTable" class="w-full h-[calc(100vh-300px)] hidden lg:block p-0 overflow-y-auto border-t">
                        <div class="min-w-full">
                            <table class="w-full min-w-max">
                                ...
                                <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                    <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-Name="John Doe" data-NIC="2001586935">
                                        <td class="py-2 text-center">001</td>
                                        <td class="py-2 text-left">John Doe</td>
                                        <td class="py-2 text-left">Center 01</td>
                                        <td class="py-2 text-left">2001586935</td>
                                        <td class="py-2 text-left">1000000/=</td>
                                        <td class="py-2 text-left">2025.07.01</td>
            ...
            <div id="inactiveSection" class="inactive-content hidden">
                ...
                <div class="flex justify-start h-full pt-2">
                    <div id="inactiveLoanIssueTable" class="w-full h-[calc(100vh-300px)] hidden lg:block p-0 overflow-y-auto border-t">
                        <div class="min-w-full">
                            <table class="w-full min-w-max">
                                <thead class="w-full text-gray-700 text-xs font-light bg-gray-200 sticky top-0">
                                    <tr class="uppercase w-full">
                                ...
                                <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                    <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-Name="Jane Smith" data-NIC="2001586940">
                                        <td class="py-2 text-center">001</td>
                                        <td class="py-2 text-left">Jane Smith</td>
                                        <td class="py-2 text-left">Center 02</td>
                                        <td class="py-2 text-left">2001586940</td>
                                        <td class="py-2 text-left">2000000/=</td>
                                        <td class="py-2 text-left">2025.06.30</td>
                                        <td class="py-2 text-center flex justify-center items-center gap-1">
                                            <a href="#" class="border rounded hover:bg-green-500">
                                                <img src="{{ asset('assets/icons/Eye.svg') }}" alt="Eye" class="h-3 w-3 m-1">
                                            </a>
...
<script>
    ...
    document.getElementById('search').addEventListener('input', function() {
        ...
        activeCards.forEach(card => {
            ...
            card.style.display = (name.includes(searchTerm) || nic.includes(searchTerm)) ? 'flex' : 'none';
        });
