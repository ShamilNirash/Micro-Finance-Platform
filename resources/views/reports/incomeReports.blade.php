    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300 lg:relative lg:py-4">
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-h-5/6"> <!--lg:h-5/6-->
            ...
            <div id="loanIssueGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2 pt-4">
                <!-- Card for a Laan -->
                <div class="rounded-md shadow flex flex-col justify-between w-full bg-blue-200 hover:bg-blue-300" data-manager="Dunura Rubasinghe" data-center="center 01">
                    <div class="h-10 py-2 flex flex-row items-center justify-center bg-blue-100 rounded-t-md space-x-2">
                    ...
                    <div class="min-w-full ">
                        <table class="w-full min-w-max">
                            ...
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-manager="John Doe" data-center="center 01">
                                    <td class="py-2 text-center">001</td>
                                    <td class="py-2 text-left">Center 01</td>
                                    <td class="py-2 text-left">08</td>
                                    <td class="py-2 text-left">John Doe</td>
                                    <td class="py-2 text-left">05</td>
                                    <td class="py-2 text-left">1000000/=</td>
                                    <td class="py-2 text-left">85000/=</td>
                                    <td class="py-2 text-left">20222/=</td>
                                ...
                                <!--Extra-->
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-manager="Minura" data-center="center 99">
                                    <td class="py-2 text-center">001</td>
                                    <td class="py-2 text-left">Center 99</td>
                                    <td class="py-2 text-left">08</td>
