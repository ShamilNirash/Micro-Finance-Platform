    ...
    <div class="h-full w-full">
        ...
        <main class="flex-1  lg:flex flex-col w-full h-full lg:p-0">
            ...
            <header class=" bg-gray-200 border-b p-4 flex justify-between items-center lg:p-4 lg:space-x-4 lg:bg-white">
                ...
                <!-- Search Bar -->
                <div class="hidden lg:flex flex-1 mx-4 text-xs">
            ...
            <div class="flex lg:h-full">
                <div class="w-full lg:w-8/12 h-full p-2 lg:border-r lg:p-4">
                    <div class="p-0 border-0  lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between h-full ">
                        ...
                        <div id="centersGrid" class="w-full h-full hidden lg:block p-0 pt-2">
                        ...
                        <!--End Centers Grid-->
                            ...
                            <div class="hidden h-full w-2/6  lg:flex flex-col justify-between">
            ...
            <div id="addBranchModal" class="fixed inset-0 bg-gray-600 hidden flex bg-opacity-50 items-center justify-center z-50">
