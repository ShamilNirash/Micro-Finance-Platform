...
<div id="mainContent" class="flex lg:h-full">
    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300  lg:relative ">
        ...
        <div id="addBranchModal" class="inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50 lg:absolute fixed p-4" style="width: 100%; height: 100%;">
        ...
        <div id="addCenterModal" class=" inset-0 bg-gray-600 bg-opacity-50 hidden  items-center justify-center z-50 lg:absolute fixed p-4" style="width: 100%; height: 100%;">
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between h-full">
            ...
            <div class="flex justify-start h-full pt-2">
                <div id="centersGridTable" class="w-full max-h-[calc(100vh-200px)]  hidden lg:block p-0 overflow-y-auto ">
