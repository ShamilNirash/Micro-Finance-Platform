    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300  lg:relative space-y-2">
                ...
                <div class="w-full lg:w-2/3 h-full">
                    ...
                    <div class="grid-cols-2 grid lg:grid-cols-3 gap-y-2 gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm">
                                <span class="view-mode">Malawaragoda</span>
                                <input type="text" class="edit-mode hidden border px-2 py-1 rounded w-full" value="Malawaragoda">
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm">
                                ...
                                <input type="text" class="edit-mode hidden border px-2 py-1 rounded w-full" value="Saman">
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm">
                                <span class="view-mode">06</span>
                                <input type="number" class="edit-mode hidden border px-2 py-1 rounded w-full" value="06">
                            </p>
                        </div>
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between h-max ">
            ...
            <div class="flex justify-start h-full ">
                ...
                <div id="centersGridTable" class="w-full max-h-[calc(100vh-400px)] hidden lg:block p-0  overflow-y-auto">
    ...
    <div id="RowDetails" class="hidden h-full lg:w-4/12 flex-col justify-between transition-all duration-300">
        ...
        <div class="bg-gray-200 p-4 ">
            <div class="w-full text-sm lg:text-xs">
                <button id="getGroupSummary" value="" class="w-full bg-blue-600 text-white py-1 rounded-lg hover:bg-blue-700 focus:outline-none flex justify-center">
