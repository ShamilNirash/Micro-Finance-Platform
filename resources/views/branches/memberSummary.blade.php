    ...
    <div id="firstColumn"
        ...
        <div class="flex flex-col h-full lg:h-auto space-y-2 pb-4">
            ...
            <div class="flex flex-col lg:flex-row h-full lg:space-x-2 space-y-2 lg:space-y-0">
                ...
                @if ($member_details->loan->contains('status', 'UNCOMPLETED'))
                <div
                    class="flex flex-col w-full lg:w-1/3 justify-between items-center p-2  rounded-lg border ">
                    ...
                    <div class="w-full justify-between">
                        ...
                        <div id="inactiveActionbuttons"
                            ...
                            <div class="flex flex-col lg:flex-row  lg:space-col lg:space-x-2 space-y-2 lg:space-y-0 bg-white lg:text-xs w-full justify-end">
                                <!-- Edit -->
                                @php
...
<div id="RowDetails" class="hidden h-[100vh] lg:w-4/12 flex-col justify-start transition-all duration-300">
    ...
    <div id="previousLoanDetails" class="activeMemberDetails previousLoan overflow-y-auto h-[calc(100vh-230px)] bg-slate-50 hidden">
    ...
    <div id="currentLoanDetails" class="activeMemberDetails currentLoan overflow-y-auto h-[calc(100vh-210px)] pb-4 bg-slate-50">
        <div class=" border-b w-full pt-4">
            <div class="w-full text-sm lg:text-xs p-4 m-0 pt-0">
                <div class="grid grid-cols-1 gap-y-2">
                                    ...
                                    <div class="flex justify-between items-center w-full space-x-2">
                                        <div class="flex w-2/3 items-center space-x-2">
                                            ...
                                            <input type="date" name="Date" id="Date"
                                                class="no-spinner mt-1 px-3 py-1 border rounded-md sp">
                                        </div>
                    ...
                    @endforeach
                    @endif
                    <!-- Sample Installment Card -->
                    <div class="bg-gray-200 py-2 px-4 rounded-lg shadow-sm ">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center space-x-2">
                                <p class="text-sm text-gray-600">Sample #1</p>
                                <button class="toggle-details-btn p-1 rounded hover:bg-sky-200">
                                    <img src="{{ asset('assets/icons/CaretDownNew.svg') }}" alt="Toggle"
                                        class="h-3 w-3 transform transition-transform">
                                </button>
                            </div>
                            <p class="text-xs text-gray-600">2025-07-24</p>
                        </div>
                        <div class="mt-0 flex justify-between items-center text-xs">
                            <div class="flex items-center space-x-2">
                                <p class="text-gray-400">Payed Amount</p>
                                <p class="font-medium text-gray-600">1000</p>
                            </div>
                            <div class="flex items-center space-x-2">
                                <p class="text-gray-400">Pay in Date</p>
                        ...
                        <div class="installment-details mt-2 hidden  w-full">
                            <div class="grid gap-2 w-full border-b ">
                                <div class="flex justify-center items-baseline">
                                    <p class="text-gray-400 w-20">1 st</p>
                                    <hr class="w-full border-gray-400">
                                </div>
                                <div class="flex items-center space-x-2">
                                    <p class="font-medium w-16"> Amount *</p>
                                    <p class="font-medium text-gray-400">1000</p>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <p class="font-medium w-16">Date *</p>
                                    <p class="font-medium text-gray-400">2025.08.23 10.57 P.M</p>
                                </div>
                                <div class="flex items-center space-x-2">
                            ...
                            <form action="#" method="POST" enctype="multipart/form-data" class="mt-2">
                                ...
                                <div class="grid gap-1">
                                    <div class="flex justify-center items-baseline">
                                        <p class="text-gray-400 w-20">2 nd</p>
                                        <hr class="w-full border-gray-400">
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <label for="sampleAmount" class="block text-xs font-medium">Amount *</label>
                                        <input type="number" name="amount" id="sampleAmount"
                                            class="no-spinner w-2/3 mt-1 px-3 py-1 border rounded-md sp"
                                            required step="0.01" value="10000">
                                    </div>
                                    <div class="flex justify-between items-center w-full space-x-2">
                                        <div class="flex w-2/3 items-center space-x-2">
                                            <label for="sampleDate" class="block text-xs font-medium">Date *</label>
                                            <input type="date" name="Date" id="sampleDate"
                                                class="no-spinner mt-1 px-3 py-1 border rounded-md sp">
                                        </div>
                                        <div class="flex w-1/3">
                                            <input type="file" name="sampleBill" id="sampleBill"
                                                class="w-full mt-1 px-2 py-1 border rounded-md text-sm bg-white">
                                        </div>
                                    </div>
                                    <div class="flex justify-end space-x-2 mt-3">
