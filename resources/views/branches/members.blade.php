        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between h-[calc(100vh-115px)]">
            ...
            <div id="memberGrid" class="grid grid-cols-2 sm:grid-cols-2 lg:hidden gap-2 p-2">
                ...
                <div class="rounded-lg shadow flex flex-col justify-between w-full bg-blue-100 hover:bg-blue-200"
                    ...
                    <div class="py-1 px-4 flex flex-col justify-center iteam-center space-y-1 w-full bg-blue-200 rounded">
...
document.addEventListener('submit', function(event) {
    ...
    function switchTab(tabType) {
        ...
        if (tabType === 'active') {
            ...
            // Update member count
            if (memberCount) {
                memberCount.textContent = `Total active members: ${memberGrid.querySelectorAll('div[data-member]:not(.inactive-member)').length}`;
            }
            ...
            // Update member count
            if (memberCount) {
                memberCount.textContent = `Total inactive members: ${memberGrid.querySelectorAll('div.inactive-member').length}`;
            }
