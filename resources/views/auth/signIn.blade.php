...
@section('content')
    <div class="flex h-screen w-screen bg-gray-100 items-center justify-center">
        ...
        <div class="h-full w-full flex md:h-5/6 md:w-4/6 md:rounded-lg md:shadow-lg md:overflow-hidden md:flex-row flex-col">
            ...
            <div
                class="hidden md:block  h-full w-full  flex-col items-center justify-center p-5 md:w-1/2 bg-blue-600 md:pt-10 px-10 ">
                <div class="flex mt-8">
            ...
            <div class="h-full w-full flex flex-col items-center justify-between bg-white p-5 xl:w-1/2">
                <div class="w-full max-w-md h-4/5 flex flex-col justify-center">
                    ...
                    <h2 class="text-center text-2xl font-semibold text-blue-700 md:text-left md:text-3xl md:font-bold mt-4">
                        Welcome back</h2>
                    <p class="text-center text-md text-gray-600 mt-2 md:text-left ">Sign in to continue</p>
                    ...
                    <form class="mt-12" id="signinForm" method="POST" action="">
                        ...
                        <div class="relative my-2 text-sm">
                            ...
                            <a href="#"
                                class="text-xs text-blue-600 absolute right-0 top-full mt-2 font-medium">Forgot
                                Password?</a>
                        </div>
                        ...
                        <button type="submit"
                            class="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 mt-4">Login</button>
                    </form>
                </div>
