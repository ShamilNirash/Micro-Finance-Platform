    ...
    <div class="p-4 flex flex-col justify-between h-full">
        ...
        <nav class="h-full overflow-hidden pt-0">
            <ul class="space-y-2 content-start min-h-full  overflow-hidden text-xs">
                ...
                <li>
                    <a href="#"
                        class="flex items-center p-2 px-4 w-full rounded-lg hover:bg-gray-100 sidebar-toggle space-x-2 active:bg-gray-200">
                ...
                <li>
                    <button
                        class="flex items-center justify-between p-2 px-4 w-full rounded-lg hover:bg-gray-100 active:bg-gray-200 sidebar-toggle space-x-2">
                    ...
                    <ul class="space-y-2 submenu hidden pl-4 mt-2 bg-white w-44">
                        <li>
                            <a href="#"
                                class="flex items-center justify-start p-1 px-4 rounded-md space-x-2 hover:bg-gray-100 active:bg-gray-200">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center p-1 px-4 rounded-md space-x-2 hover:bg-gray-100 active:bg-gray-200">
...
<div id="mobileSidebar"
    class="absolute max-h-fit top-16 bottom-5 mac-h-1/2 w-60 inset-0 shadow md:hidden hidden ml-4 mt-2 rounded-xl bg-gray-200">
    <div class="p-4">
            ...
            <ul class="space-y-1 min-h-full  overflow-y-scroll  scrollbar-hide scroll-smooth">
                ...
                <li>
                    <a href="#"
                        ...
                        <img src="{{ asset('assets/icons/DiamondsFour.svg') }}" alt="Dashboard Icon"
                            class="h-4 w-4 ">
                        <span class="sidebar-text">Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <button
                        class="flex items-center justify-between p-1 px-4 w-full rounded-lg hover:bg-gray-100 sidebar-toggle space-x-2">
                        <div class="flex items-center space-x-2">
                            <img src="{{ asset('assets/icons/Users.svg') }}" alt="Branches Icon" class="h-4 w-4">
                            <span class="sidebar-text">Branches</span>
                        </div>
