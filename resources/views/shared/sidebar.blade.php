    ...
    <div class="p-4 flex flex-col justify-between h-full">
        ...
        <nav class="h-full overflow-hidden pt-0">
            <ul class="space-y-2 content-start min-h-full  overflow-hidden text-xs">
                <!-- Dashboard -->
                <li>
                    <a href="#" class="flex items-center p-2 px-4 w-full rounded-lg hover:bg-sky-100 sidebar-toggle space-x-2 active:bg-sky-100">
                ...
                <li>
                    ...
                    <ul class="space-y-2 submenu hidden pl-4 mt-2 bg-white w-44">
                        <li>
                            <a href="#" class="flex items-center justify-start p-1 px-4 rounded-md space-x-2 hover:bg-sky-100 active:bg-sky-200">
                                <img src="{{ asset('assets/icons/MapPinLine.svg') }}" alt="Centers Icon" class="h-4 w-4">
                                <span class="sidebar-text-mini">Centers</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-1 px-4 rounded-md space-x-2 hover:bg-sky-100 active:bg-sky-200">
