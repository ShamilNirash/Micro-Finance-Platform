    ...
    <div class="hidden sm:flex flex-1 mx-4 text-xs">
        <div class="relative w-11/12 ">
            <input type="text" placeholder="Search..."
                class="w-full px-4 py-1 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500  bg-gray-50">
            <button class="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-600 pr-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 21l-6-6m2.828-4.828A7.962 7.962 0 0018 10a8 8 0 10-8 8c1.657 0 3.175-.51 4.414-1.414l4.586 4.586z">
                    </path>
                </svg>
            </button>
        </div>
