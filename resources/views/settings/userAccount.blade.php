    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300 lg:relative lg:py-4">
            ...
            <div class="bg-white shadow-xl w-full max-w-lg rounded-lg border border-blue-400">
                ...
                <form id="addNewMemberForm" class="p-4 space-y-6">
                    <div class="flex justify-center mb-4">
                        <div class="relative">
                            <img src="https://via.placeholder.com/100" alt="User Profile" class="rounded-full w-24 h-24 object-cover border-2 border-gray-300 bg-gray-800">
                            <label for="newMemberImage" class="absolute bottom-0 right-0 bg-blue-500 text-white rounded-full w-6 h-6 flex items-center justify-center cursor-pointer">
                    ...
                    <div class="space-y-2">
                        <div class="flex space-x-4 items-center">
                            ...
                            <div class="flex w-full space-x-2">
                                <input type="text" id="newMemberFirstName" placeholder="1st name" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300  hover:border-gray-400 ">
                                <input type="text" id="newMemberLastName" placeholder="2nd name" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300  hover:border-gray-400 ">
                            </div>
                        </div>
                        <div class="flex space-x-4 items-center ">
                            <label class="block text-xs text-gray-700 w-1/3">Email*</label>
                            <input type="email" id="newMemberEmail" placeholder="Enter Email" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300  hover:border-gray-400 " required>

                        </div>
                        <div class="flex space-x-4 items-center">
                            <label class="block text-xs text-gray-700 w-1/3">Default Password*</label>
                            <input type="password" id="newMemberPassword" placeholder="password" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300  hover:border-gray-400 " required>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex w-full lg:space-x-4 space-y-2 lg:space-y-0 items-center flex-col lg:flex-row">
                                <div class="flex space-x-4 lg:w-1/2 w-full  items-center">
                                    ...
                                    <input type="text" id="newMemberNIC" placeholder="type" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300  hover:border-gray-400 " required>
                                </div>
                                <div class="flex space-x-4 lg:w-1/2 w-full  items-center">
                                    <label class="block text-xs text-gray-700 ">Mobile Number 01*</label>
                                    <input type="tel" id="newMemberMobile01" placeholder="type" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300  hover:border-gray-400 " required>
                                </div>
                            </div>
                            <div class="flex w-full lg:space-x-4 space-y-2 lg:space-y-0 items-center flex-col lg:flex-row">
                                <!-- First file input -->
                    ...
                    <div class="flex justify-end space-x-4 mt-2">
                        <button type="button" id="cancelNewMember" class="px-6 py-1 bg-gray-300 rounded-lg hover:bg-gray-400 focus:outline-none text-sm">Cancel</button>
                        <button type="submit" id="createNewMember" class="px-6 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none text-sm">Create</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="editUserModal"
            ...
            <div class="bg-white shadow-xl w-full max-w-lg rounded-lg border border-blue-400">
                ...
                <form id="editMemberForm" class="p-4 space-y-6">
                    ...
                    <div class="flex justify-center mb-4">
                        <div class="relative">
                            <img id="editMemberProfileImage" src="https://via.placeholder.com/100" alt="User Profile" class="rounded-full w-24 h-24 object-cover border-2 border-gray-300 bg-gray-200">
                            <label for="editMemberImage" class="absolute bottom-0 right-0 bg-blue-500 text-white rounded-full w-6 h-6 flex items-center justify-center cursor-pointer">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                            </label>
                    ...
                    <div class="space-y-2">
                        <div class="flex space-x-4 items-center">
                            <label class="block text-xs text-gray-700 w-1/3">Name*</label>
                            <div class="flex w-full space-x-2">
                                <input type="text" id="editMemberFirstName" placeholder="1st name" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400">
                                <input type="text" id="editMemberLastName" placeholder="2nd name" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400">
                            </div>
                        </div>
                        <div class="flex space-x-4 items-center">
                            <label class="block text-xs text-gray-700 w-1/3">Email*</label>
                            <input type="email" id="editMemberEmail" placeholder="Enter Email" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" required>
                        </div>
                        <div class="flex space-x-4 items-center">
                            <label class="block text-xs text-gray-700 w-1/3">Password</label>
                            <div class="w-full flex items-center space-x-2">
                                <input type="text" id="editMemberPassword" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" readonly>
                                <button type="button" id="togglePasswordVisibility" class="p-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none">
                                    <svg id="passwordEyeIcon" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="space-y-2">
                            <div class="flex w-full lg:space-x-4 space-y-2 lg:space-y-0 items-center flex-col lg:flex-row">
                                <div class="flex space-x-4 lg:w-1/2 w-full items-center">
                                    <label class="block text-xs text-gray-700 w-1/3">NIC Number*</label>
                                    <input type="text" id="editMemberNIC" placeholder="type" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" required>
                                </div>
                                <div class="flex space-x-4 lg:w-1/2 w-full items-center">
                                    <label class="block text-xs text-gray-700">Mobile Number 01*</label>
                                    <input type="tel" id="editMemberMobile01" placeholder="type" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" required>
                                </div>
                            </div>
                            <div class="flex w-full lg:space-x-4 space-y-2 lg:space-y-0 items-center flex-col lg:flex-row">
                                <!-- First file input -->
                                ...
                                <!-- Second file input -->
                                <div class="lg:w-1/2 w-full">
                                    <label class="flex items-center justify-center border border-gray-300 hover:border-gray-400 rounded-md w-full h-8 cursor-pointer transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-gray-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                                        <span class="text-xs text-gray-700">Attach image</span>
                    ...
                    <div class="flex justify-end space-x-4 mt-2">
                        <button type="button" id="cancelEditMember" class="px-6 py-1 bg-gray-300 rounded-lg hover:bg-gray-400 focus:outline-none text-sm">Cancel</button>
                        <button type="submit" id="saveEditMember" class="px-6 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none text-sm">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="deleteUserModal"
            ...
            <div class="bg-white shadow-xl w-full max-w-lg rounded-lg border border-red-400">
                ...
                <div class="p-4 space-y-6">
                    ...
                    <div class="flex justify-end space-x-4 mt-2">
                        <button type="button" id="cancelDeleteUser" class="px-6 py-1 bg-gray-300 rounded-lg hover:bg-gray-400 focus:outline-none text-sm">Cancel</button>
                        <button type="button" id="confirmDeleteUser" class="px-6 py-1 bg-red-600 text-white rounded-lg hover:bg-red-700 focus:outline-none text-sm">Delete</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form id="changePasswordForm" class="p-4 space-y-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex space-x-4 items-center">
                            ...
                            <input type="password" id="currentPassword" placeholder="Enter current password" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" required>
                        </div>
                        ...
                        <div class="flex space-x-4 items-center">
                            ...
                            <input type="password" id="newPassword" placeholder="Enter new password" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" required>
                        </div>
                        <div class="flex space-x-4 items-center">
                            <label class="block text-xs text-gray-700 w-1/3">Confirm Password*</label>
                            <input type="password" id="confirmPassword" placeholder="Confirm new password" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs border-gray-300 hover:border-gray-400" required>
                        </div>
                    </div>
                    <div class="flex justify-end space-x-4 mt-2">
                        <button type="button" id="cancelChangePassword" class="px-6 py-1 bg-gray-300 rounded-lg hover:bg-gray-400 focus:outline-none text-sm">Cancel</button>
                        <button type="submit" id="saveChangePassword" class="px-6 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none text-sm">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-full"> <!--lg:h-5/6-->
            ...
            <div id="userGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2 pt-4">
                <!-- Card -->
                <div class="rounded-lg shadow-sm border border-gray-200 p-4 pt-2 bg-gray-100 w-full space-y-2 text-xs" data-name="John Doe" data-NIC="200123456789">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pb-2">
                        ...
                        <div class="flex space-x-2 items-center">
                            ...
                            <p class="text-gray-600"><span class="bg-yellow-600 p-0.5 px-2 rounded-md text-white text-xs inline-block text-center min-w-[100px] justify-items-center ">Super Admin</span></p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 border-t pt-4">
                        <div class="flex justify-between items-center text-sm space-x-2">
                            <a href="#" class="border rounded-lg hover:bg-blue-700 bg-blue-600 flex-shrink-0 edit-user px-4 py-1 text-white" >
                                Edit
                            </a>
                            <a href="#" class="border rounded-lg hover:bg-red-700 bg-red-600 flex-shrink-0 delete-user px-4 py-1 text-white" >
                                Delete
                            </a>
                            <a href="#" class="border rounded-lg hover:bg-green-700 bg-green-600 flex-shrink-0 change-password px-4 py-1 text-white" data-id="001">
                                Password Change
                            </a>
                        </div>
                    </div>
                ...
                <div class="rounded-lg shadow-sm border border-gray-200 p-4 pt-2 bg-gray-100 w-full space-y-2 text-xs" data-name="John Doe" data-NIC="200123456789">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        ...
                        <div class="flex space-x-2 items-center">
                            <p class="font-semibold text-gray-700">Role:</p>
                            <p class="text-gray-600"> <span class="bg-green-600 p-0.5 px-2 rounded-md text-white text-xs inline-block text-center min-w-[100px]">Center Manager</span></p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 border-t pt-4">
                        <div class="flex justify-between items-center text-sm space-x-2">
                            ...
                            <a href="#" class="border rounded-lg hover:bg-red-700 bg-red-600 flex-shrink-0 delete-user px-4 py-1 text-white" data-id="001">
                                Delete
                            </a>
                            <a href="#" class="border rounded-lg hover:bg-green-700 bg-green-600 flex-shrink-0 change-password px-4 py-1 text-white" data-id="001">
                                Password Change
                ...
                <!-- Sample for a center -->
                <div class="rounded-lg shadow-sm border border-gray-200 p-4 pt-2 bg-gray-100 w-full space-y-2 text-xs" data-name="John Doe" data-NIC="200285966895">
                    <div class="flex justify-between items-center border-b pb-2">
                        <div class="flex space-x-4 items-center">
                            <div class="h-8 w-8 rounded-full bg-black"></div>
                            <div class="flex flex-col space-y-0">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        ...
                        <div class="flex space-x-2 items-center">
                            <p class="font-semibold text-gray-700">Role:</p>
                            <p class="text-gray-600"><span class="bg-blue-600 p-0.5 px-2 rounded-md text-white text-xs inline-block text-center min-w-[100px] justify-items-center ">Admin</span></p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 border-t pt-4">
                        <div class="flex justify-between items-center text-sm space-x-2">
                            ...
                            <a href="#" class="border rounded-lg hover:bg-green-700 bg-green-600 flex-shrink-0 change-password px-4 py-1 text-white" >
                                Password Change
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="min-w-full overflow-x-auto">
                        <table class="w-full min-w-[900px]"> <!-- Added min-width to prevent crushing -->
                            ...
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-name="Dunura" data-NIC="20028596427">
                                    ...
                                    <td class="py-2 text-center">
                                        <span class="bg-blue-600 p-1 px-2 rounded-md text-white text-xs inline-block text-center min-w-[100px]">Admin</span>
                                    </td>
                                    <td class="py-2 text-center">
                                        <div class="flex justify-center">
                                            <div class="toggle-switch" onclick="toggleActive(this)">
                                    ...
                                    <td class="py-2 text-center">
                                        <div class="flex justify-center items-center gap-1">
                                            ...
                                            <a href="#" class="border rounded hover:bg-yellow-500 flex-shrink-0 change-password">
                                                <img src="{{ asset('assets/icons/Lock.svg') }}" alt="Change Password" class="h-3 w-3 m-1">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                <!--Extra-->
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-name="John Doe" data-NIC="200285966895">
                                    ...
                                    <td class="py-2 text-center">
                                        <span class="bg-yellow-600 p-1 px-2 rounded-md text-white text-xs inline-block text-center min-w-[100px]">Super Admin</span>
                                    </td>
                                    <td class="py-2 text-center">
                                        <div class="flex justify-center">
                                            <div class="toggle-switch" onclick="toggleActive(this)">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-name="John Doe" data-NIC="200285966895">
                                    ...
                                    <td class="py-2 text-center">
                                        <span class="bg-green-600 p-1 px-2 rounded-md text-white text-xs inline-block text-center min-w-[100px]">Center Manager</span>
                                    </td>
                                    <td class="py-2 text-center">
                                        <div class="flex justify-center">
                                            <div class="toggle-switch" onclick="toggleActive(this)">
...
<script>
    ...
    document.addEventListener('click', function(e) {
        ...
        if (container.tagName === 'TR') {
            ...
            name = container.querySelector('div:nth-child(1) div:nth-child(1) p:nth-child(2)').textContent.trim();
            email = container.querySelector('div:nth-child(2) div:nth-child(1) p:nth-child(2)').textContent.trim();
            phone = container.querySelector('div:nth-child(2) div:nth-child(2) p:nth-child(2)').textContent.trim();
    ...
    document.getElementById('confirmDeleteUser').addEventListener('click', function() {
        ...
        const row = document.querySelector(`#userTable tbody tr td:first-child:contains(${userId})`)?.closest('tr');
        if (row) row.remove();
