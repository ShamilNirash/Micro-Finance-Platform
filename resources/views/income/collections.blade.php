                    ...
                    <div class="min-w-full h-full">
                        <table class="w-full min-w-max">
                            ...
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-center-id="1" data-branch-name="Balangoda" data-center-name="Malwaragoda" data-manager="John Doe" data-group-count="4" data-loan-count="10" data-today-income="1000000" data-date="2025-06-01">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-center-id="2" data-branch-name="Ella" data-center-name="Ella Center 01" data-manager="Saman Perera" data-group-count="3" data-loan-count="8" data-today-income="1500000" data-date="2025-06-10">
                                    <td class="pl-2 text-left">
