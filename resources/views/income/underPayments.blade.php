    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300 lg:relative lg:py-4">
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-5/6">
            ...
            <div class="flex flex-col w-full space-y-2 p-2 lg:px-2 text-md lg:flex lg:flex-row lg:space-y-0 lg:justify-between lg:items-center lg:p-1">
                ...
                <!-- Date filter -->
                <div id="dateFilter" class="flex flex-col lg:flex-row w-full justify-end lg:space-x-2 space-y-2 lg:space-y-0 lg:w-1/2">
            ...
            <div id="centersGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2">
                <!-- Card for a center -->
                <div class="rounded-md shadow flex flex-col justify-between w-full bg-blue-200 hover:bg-blue-300" data-center="Malwaragoda" data-branch="balangoda">
                    <div class="h-12 flex flex-col items-center justify-center bg-blue-100 rounded-t-md">
                        <p class="text-sm font-bold text-gray-800">Malwaragoda</p>
                    ...
                    <div class="h-max py-2 px-4 flex flex-col justify-between space-y-1">
                        ...
                        <div class="text-xs flex items-center space-x-1">
                            <p>To Receive:</p>
                            <p class="text-gray-700">1000000/=</p>
                        </div>
                    </div>
                </div>
                <!-- Sample for a center -->
                <div class="rounded-md shadow flex flex-col justify-between w-full bg-blue-200 hover:bg-blue-300" data-center="Ella Center" data-branch="ella">
                    <div class="h-12 flex flex-col items-center justify-center bg-blue-100 rounded-t-md">
                    ...
                    <div class="min-w-full h-full">
                        <table class="w-full min-w-max">
                            ...
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-center-id="1" data-branch-name="Balangoda" data-center-name="Malwaragoda" data-manager="John Doe" data-group-count="4" data-loan-count="10" data-to-receive="1000000" data-date="2025-06-01">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-center-id="2" data-branch-name="Ella" data-center-name="Ella Center 01" data-manager="Saman Perera" data-group-count="3" data-loan-count="8" data-to-receive="1500000" data-date="2025-06-10">
                                    <td class="pl-2 text-left">
                                        <input type="checkbox" name="selected_ids[]" value="2" class="form-checkbox h-4 w-4 text-blue-600 m-1">
                                    </td>
                                    <td class="py-2 text-left">002</td>
                                    <td class="py-2 text-left">Ella Center 01</td>
                                    <td class="py-2 text-left">Saman Perera</td>
                                    <td class="py-2 text-left">3</td>
                                    <td class="py-2 text-left">8</td>
                                    <td class="py-2 text-left">1500000/=</td>
                                    <td class="py-2 text-center flex justify-center items-center gap-1">
                                        <a href="#" class="border rounded hover:bg-green-500">
                                            <img src="{{ asset('assets/icons/Eye.svg') }}" alt="Eye" class="h-3 w-3 m-1">
                                        </a>
        ...
        <div id="RowDetailsContent" class="border-b p-4 h-2/8">
            ...
            <div class="grid grid-cols-2 gap-y-2">
                ...
                <div>
                    ...
                    <p id="toReceive" class="text-sm mt-0">-</p>
                </div>
            </div>
        </div>
        <!--Group List-->
        <div class="p-4 overflow-auto h-5/8 max-h-[calc(100vh-250px)] space-y-2">
            ...
            <div class="border bg-sky-50 flex justify-between items-center p-2 px-4 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-gray-600">1000000/=</p>
                </div>
            </div>
            <!--Card-->
            <div class="border bg-sky-50 flex justify-between items-center p-2 px-4 rounded-lg">
                ...
                <div>
                    <p class="text-xs text-gray-400">To Receive</p>
                    <p class="text-xs font-medium text-gray-600">1500000/=</p>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.querySelectorAll('.view-details').forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            const toReceive = row.getAttribute('data-to-receive');
            ...
            document.getElementById('toReceive').textContent = toReceive;
        });
    });
</script>
@endsection