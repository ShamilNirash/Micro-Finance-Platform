    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300  lg:relative lg:py-4  ">
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-5/6">
            ...
            <div id="centersGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2">
                ...
                <!-- Sample for a center -->
                <div class="rounded-md shadow flex flex-col justify-between w-full bg-blue-200 hover:bg-blue-200" data-center="Ella Center" data-branch="ella">
                    <div class="h-12 flex flex-col items-center justify-center bg-blue-100  rounded-t-md">
                        ...
                        <table class="w-full min-w-max">
                            <thead class="w-full text-gray-700 text-xs font-light bg-gray-200 sticky top-0">
                                <tr class="uppercase w-full">
                                    ...
                                    <th class="py-2 text-left">Total Loan</th>
                                    <th class="py-2 text-left">To Recived</th>
                                    <th class="py-2 text-left">Today Income</th>
                                    <th class="py-2 text-center">Action</th>
                                </tr>
                            </thead>
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg  view-details" data-center-id="1" data-branch-name="Balangoda" data-center-name="Malwaragoda" data-manager="John Doe" data-loan-count="4" data-to-recive="2000" data-today-income="1000000" data-date="2025-06-01">
                                    ...
                                    <td class="py-2 text-left">02</td>
                                    <td class="py-2 text-left">1000000</td>
                                    <td class="py-2 text-left">1010100</td>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg  view-details" data-center-id="2" data-branch-name="Ella" data-center-name="Ella Center 01" data-manager="Saman Perera" data-loan-count="3" data-to-recive="1500" data-today-income="1500000" data-date="2025-06-10">
                                    <td class="pl-2 text-left">
                                    ...
                                    <td class="py-2 text-left">01</td>
                                    <td class="py-2 text-left">1500</td>
