        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-full">
            ...
            <div class="flex flex-col w-full space-y-2 p-2 lg:px-2 text-md lg:flex lg:flex-row lg:space-y-0 lg:justify-between lg:items-center lg:p-1">
                ...
                <div class="w-full text-sm lg:w-5/12">
                    <input type="text" id="searchMember" placeholder="Search ..." class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 ring-blue-500 bg-white">
                </div>
            </div>
            <!--CARD SECTION-->
            <div id="memberGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2">
                <!-- Card for a center -->
                <div class="rounded-md shadow flex flex-col justify-between w-full border bg-gray-100 hover:bg-gray-300" data-member="Dunura" data-center="balangoda" data-loan-balance="85955200" data-installment="2000 (2 missed)" data-total-amount="6000">
                    ...
                    <div class="h-max py-2 px-4 flex flex-col justify-between space-y-1 bg-gray-200 hover:bg-gray-300">
                        ...
                        <div class="grid grid-cols-2 w-full">
                            <div class="text-xs flex items-center space-x-1">
                                ...
                                <p class="text-gray-700">2,000 (2 missed)</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 w-full">
                            <div class="text-xs flex items-center space-x-1">
                                <p class="">Total Amount :</p>
                                <p class="text-gray-700">6,000</p>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Sample card -->
                <div class="rounded-md shadow flex flex-col justify-between w-full border bg-gray-100 hover:bg-gray-300" data-member="Minura" data-center="balangoda" data-loan-balance="85500" data-installment="2000 (1 missed)" data-total-amount="2000">
                    <div class="h-8 flex flex-col items-center justify-center rounded-t-md">
                    ...
                    <div class="h-max py-2 px-4 flex flex-col justify-between space-y-1 bg-gray-200 hover:bg-gray-300">
                        ...
                        <div class="grid grid-cols-2 w-full">
                            <div class="text-xs flex items-center space-x-1">
                                <p class="">Installment :</p>
                                <p class="text-gray-700">2,000 (1 missed)</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 w-full">
                            <div class="text-xs flex items-center space-x-1">
                    ...
                    <div class="min-w-full h-full">
                        <table class="w-full min-w-max">
                            ...
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white w-full">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-member-name="Dunura Hansaja" data-center-name="Maharagama" data-loan-balance="20000" data-installment="2000 (2 missed)" data-total-amount="6000">
                                    <td class="pl-4 py-2 text-left">001</td>
                                    <td class="py-2 text-left">Dunura Hansaja</td>
                                    <td class="py-2 text-left">Maharagama</td>
                                    <td class="py-2 text-center">20,000</td>
                                    <td class="py-2 text-center"><span class="bg-yellow-400 p-1 px-4 rounded ">2,000</span> <span class="bg-amber-500 p-1 px-2 rounded">02</span></td>
                                    <td class="py-2 text-center"><span class="bg-red-600 p-1 px-4 rounded text-white">8,000</span> </td>
                                    <td class="py-2 text-center flex justify-center items-center gap-1">
                                        ...
                                        <a href="#" class="border rounded hover:bg-lime-500">
                                            <img src="{{ asset('assets/icons/Money.svg') }}" alt="Money" class="h-3 w-3 m-1">
                                        </a>
                                    </td>
                                </tr>
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-member-name="Minura" data-center-name="Maharagama" data-loan-balance="85000" data-installment="2000 (1 missed)" data-total-amount="2000">
                                    <td class="pl-4 py-2 text-left">002</td>
                                    <td class="py-2 text-left">Minura</td>
                                    <td class="py-2 text-left">Maharagama</td>
                                    <td class="py-2 text-center">85,000</td>
                                    <td class="py-2 text-center"><span class="bg-yellow-400 p-1 px-4 rounded">8,000</span> <span class="bg-amber-500 p-1 px-2 rounded">01</span></td>
                                    <td class="py-2 text-center"><span class="bg-red-600 p-1 px-4 rounded text-white">2,000</span> </td>
                                    <td class="py-2 text-center flex justify-center items-center gap-1">
                                        <a href="#" class="border rounded hover:bg-green-500">
                                            <img src="{{ asset('assets/icons/Eye.svg') }}" alt="Eye" class="h-3 w-3 m-1">
                                        </a>
                    ...
                    <div class="bg-gray-200 p-4 rounded-lg shadow-md">
                        ...
                        <div class="mt-2 flex justify-between items-center text-xs">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <p class="text-xs font-medium p-1 bg-red-500 rounded px-2">NO</p>
                            </div>
                        </div>
...
<script>
    ...
    document.querySelectorAll('.view-details').forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            const loanBalance = row.getAttribute('data-loan-balance');
            const installment = row.getAttribute('data-installment');
            const totalAmount = row.getAttribute('data-total-amount');

            document.getElementById('Mname').textContent = memberName;
            document.getElementById('Path').textContent = `Branch > ${centerName} > Group`;
            document.getElementById('LoanBalance').textContent = loanBalance;
