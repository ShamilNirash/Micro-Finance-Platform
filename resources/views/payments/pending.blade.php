    ...
    <div id="firstColumn" class="w-full h-full p-2 lg:border-r lg:p-4 transition-all duration-300 lg:relative lg:py-4">
        ...
        <div class="p-0 border-0 lg:py-2 lg:bg-sky-50 lg:border rounded-lg flex flex-col justify-between lg:h-full">
            ...
            <div id="memberGrid" class="grid grid-cols-1 sm:grid-cols-1 lg:hidden gap-4 p-2">
                <!-- Card for a center -->
                <div class="rounded-md shadow flex flex-col justify-between w-full border bg-gray-100 hover:bg-gray-300" data-member="Dunura" data-center="balangoda" data-loan-balance="85955200" data-pending-amount="2000">
                ...
                <!-- Sample card -->
                <div class="rounded-md shadow flex flex-col justify-between w-full border bg-gray-100 hover:bg-gray-300" data-member="Minura" data-center="balangoda" data-loan-balance="85500" data-pending-amount="2000">
                    <div class="h-8 flex flex-col items-center justify-center rounded-t-md">
                    ...
                    <div class="min-w-full h-full">
                        <table class="w-full min-w-max">
                            ...
                            <tbody id="tableBody" class="text-gray-800 text-xs font-light bg-white w-full">
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-member-name="Dunura Hansaja" data-center-name="Maharagama" data-loan-balance="20000" data-pending-amount="2000">
                                    ...
                                    <td class="py-2 text-center"><span class="bg-yellow-400 p-1 px-4 rounded">2,000</span> </td>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-sky-100 cursor-pointer rounded-lg view-details" data-member-name="Minura" data-center-name="Maharagama" data-loan-balance="85000" data-pending-amount="2000">
...
<script>
    ...
    document.querySelectorAll('.view-details').forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            const pendingAmount = row.getAttribute('data-pending-amount');
